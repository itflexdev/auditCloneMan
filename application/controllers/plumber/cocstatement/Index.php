...
class Index extends CC_Controller 
{
	...
	public function DTCocStatement()
	{
		...
		$totalcount 	= $this->Coc_Model->getCOCList('count', ['user_id' => $userid, 'coc_status' => ['2','4','5','7']]+$post, ['coclog', 'coclogprovince', 'coclogcity', 'coclogsuburb', 'coclogcompany', 'reseller', 'resellerdetails']);
		$results 		= $this->Coc_Model->getCOCList('all', ['user_id' => $userid, 'coc_status' => ['2','4','5','7']]+$post, ['coclog', 'coclogprovince', 'coclogcity', 'coclogsuburb', 'coclogcompany', 'reseller', 'resellerdetails']);
