...
class Index extends CC_Controller
{
	...
	{
		$pagedata['totalplumber'] 		= $this->Plumber_Model->getList('count', ['type' => '3'], ['users']);
		...
		$pagedata['designationl'] 		= $this->Plumber_Model->getList('count', ['type' => '3', 'designation' => ['1']], ['users', 'usersplumber']);
		$pagedata['designationtap'] 	= $this->Plumber_Model->getList('count', ['type' => '3', 'designation' => ['2']], ['users', 'usersplumber']);
		$pagedata['designationtop'] 	= $this->Plumber_Model->getList('count', ['type' => '3', 'designation' => ['3']], ['users', 'usersplumber']);
		$pagedata['designationqp'] 		= $this->Plumber_Model->getList('count', ['type' => '3', 'designation' => ['4']], ['users', 'usersplumber']);
		$pagedata['designationlp'] 		= $this->Plumber_Model->getList('count', ['type' => '3', 'designation' => ['5']], ['users', 'usersplumber']);
		$pagedata['designationmp'] 		= $this->Plumber_Model->getList('count', ['type' => '3', 'designation' => ['6']], ['users', 'usersplumber']);
		
		$pagedata['racial1'] 			= $this->Plumber_Model->getList('count', ['type' => '3', 'racial' => ['1']], ['users', 'usersplumber']);
		$pagedata['racial2'] 			= $this->Plumber_Model->getList('count', ['type' => '3', 'racial' => ['2']], ['users', 'usersplumber']);
		$pagedata['racial3'] 			= $this->Plumber_Model->getList('count', ['type' => '3', 'racial' => ['3']], ['users', 'usersplumber']);
		$pagedata['racial4'] 			= $this->Plumber_Model->getList('count', ['type' => '3', 'racial' => ['4']], ['users', 'usersplumber']);
		
		$pagedata['genderm'] 			= $this->Plumber_Model->getList('count', ['type' => '3', 'gender' => ['1']], ['users', 'usersdetail']);
		$pagedata['genderf'] 			= $this->Plumber_Model->getList('count', ['type' => '3', 'gender' => ['2']], ['users', 'usersdetail']);
