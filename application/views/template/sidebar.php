		...
		<nav class="sidebar-nav">
			<ul id="sidebarnav">
				<?php if($type=='1' || $type=='2'){ ?>
					...
					<?php }if($menu=='1' || ($menu=='2' && in_array('12', $parent))){ ?>	
						<li class=""> 
                    ...
                    ?>
						...
						?>
							...
							<li>
								<div class="row side_list">
									<div class="col-sm-3 col-md-3 col-lg-3 list_icon">
										<a href="<?php echo base_url().'plumber/lms/index'; ?>"><i class="fa fa-book" aria-hidden="true"></i></a>
									</div>
									<div class="col-sm-9 col-md-9 col-lg-9 list_name">
										<a href="<?php echo base_url().'plumber/lms/index'; ?>" class="cus_li_name"><p class="custom_li">LMS</p></a>
									</div>
								</div>
							</li>
							<?php } ?>
