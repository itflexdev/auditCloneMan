	...
	<div class="col-md-7 align-self-center text-right">
		<div class="d-flex justify-content-end align-items-center">
			<ol class="breadcrumb">
				...
				<li class="breadcrumb-item"><a href="<?php echo base_url().'admin/audits/index'; ?>">Auditor Profile</a></li>
			...
			<div class="row">
				...
				<div class="col-md-12">	
					<div class="form-group ">
						...
						<form action="<?php echo base_url().'admin/audits/index/diary'; ?>" method="post" class="form">
