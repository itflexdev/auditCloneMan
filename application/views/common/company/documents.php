...
<div class="row page-titles">
	...
	<div class="col-md-7 align-self-center text-right">
		<div class="d-flex justify-content-end align-items-center">
			<ol class="breadcrumb">
				<li class="breadcrumb-item"><a href="<?php echo base_url().'company/dashboard/index'; ?>">Home</a></li>
				<li class="breadcrumb-item"><a href="<?php echo base_url().'company/profile/index'; ?>">Company</a></li>
...
function datatable(destroy=0){
	...
	var options = {
		url 	: 	'<?php echo base_url()."company/documents/index/DTDocuments"; ?>',
