	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				...
				<form id="pyamentform" action="<?php echo $this->config->item('paymenturl'); ?>" method="post">
...
<script>
	$(function(){
		...
		var options = {
			url 	: 	'<?php echo base_url()."company/accountdetails/index/DTAccounts"; ?>',	
			data	: 	{page : 'companyaccount'},		
			columns : 	[
							{ "data": "description" },
							{ "data": "inv_id" },
							{ "data": "created_at" },
